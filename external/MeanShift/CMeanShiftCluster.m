function [clustCent,data2cluster,clusterVotes,cluster2dataCell] = CMeanShiftCluster(dataPts,bandWidth,plotFlag)
% the "prior" stuff didn't seem to make a significant difference in real
% tests. This is that version with it stripped out.
